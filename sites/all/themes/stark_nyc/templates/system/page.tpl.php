...
<div id="page">
  ...
  <nav id="navigation" role="navigation" class="navigation clearfix">
    <div id="topbar" role="navigation" class="topbar">
      <div class="container">
    ...
    <section id="main" role="main" class="clearfix">
      <div class="container">
        ...
        <?php if ($page['main_prefix']): ?>
          <aside id="main-prefix" class="main-prefix">
            <?php print render($page['main_prefix']); ?>
          </aside>
        <?php endif; ?>

        <article id="content" role="main" class="clearfix">
          <a id="main-content"></a>
          <header>
        ...
        <?php if ($page['main_suffix']): ?>
          <aside id="main-suffix" class="main-suffix">
